      ...
      <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                  <li class="nav-item">
                      <a class="nav-link py-3 fs-6 active" aria-current="page" href="#/">Beranda</a>
                  </li>
                  <li class="nav-item ">
  ...
  <div class="offcanvas offcanvas-end pt-3 bg-lig" tabindex="-1" id="offcanvasExample"
      ...
      <div class="offcanvas-header">
          <h5 class="offcanvas-title px-5" id="offcanvasExampleLabel">
              <span class="brand-text ms-auto fs-4">PeduliLingkungan</span>
          </h5>
  
      </div>
      <div class="offcanvas-body mt-4">
          <div class="row justify-content-center">
              <a id="active" class="text-center offcanvas-item py-3 fs-6" aria-current="page"
                  href="#/">Beranda</a>
          </div>
          <div class="row justify-content-center">
